...
import { last, isObject, getClosestItem, zipper, isDefined, isNotDefined, functor, mapObject } from "./index";
	...
	return React.Children.map(children, function (each) {
		if (each && each.type.toString() === Chart.toString()) {
			...
			var yPan = chartProps.yPan,
			    _chartProps$yPanEnabl = chartProps.yPanEnabled,
			    yPanEnabled = _chartProps$yPanEnabl === undefined ? false : _chartProps$yPanEnabl;
